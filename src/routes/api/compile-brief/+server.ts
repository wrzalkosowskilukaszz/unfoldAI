...
3. Use these four section headers, in this order: Executive Summary, Target Audience, Deliverables, Constraints.
...
Context & Objectives notes:
${sections.objectives?.trim() || '(not provided)'}

Target Audience notes:
${sections.audience?.trim() || '(not provided)'}

Deliverables notes:
${sections.deliverables?.trim() || '(not provided)'}

Constraints notes:
${sections.constraints?.trim() || '(not provided)'}
